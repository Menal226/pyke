from ..models.currentGameInfoDto import CurrentGameInfoDto
...
class SpectatorEndpoint:
    ...
    async def by_puuid(self, region: Region, puuid: str) -> CurrentGameInfoDto:
        ...
        **Returns:**
        ...
        return CurrentGameInfoDto.from_dict(data)
